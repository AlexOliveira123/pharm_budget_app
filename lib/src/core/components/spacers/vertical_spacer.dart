...
class VerticalSpacer extends StatelessWidget {
  ...
  factory VerticalSpacer.x2() {
    return const VerticalSpacer._(spacing: AppSpacing.x2);
  }

  factory VerticalSpacer.x3() {
    return const VerticalSpacer._(spacing: AppSpacing.x3);
  }

  factory VerticalSpacer.x4() {
    return const VerticalSpacer._(spacing: AppSpacing.x4);
  }

  factory VerticalSpacer.x5() {
    return const VerticalSpacer._(spacing: AppSpacing.x5);
  }

  factory VerticalSpacer.x6() {
    return const VerticalSpacer._(spacing: AppSpacing.x6);
  }

  factory VerticalSpacer.x7() {
    return const VerticalSpacer._(spacing: AppSpacing.x7);
  }

  factory VerticalSpacer.x8() {
    return const VerticalSpacer._(spacing: AppSpacing.x8);
  }

  factory VerticalSpacer.x9() {
    return const VerticalSpacer._(spacing: AppSpacing.x9);
  }

  factory VerticalSpacer.x10() {
    return const VerticalSpacer._(spacing: AppSpacing.x10);
  }
